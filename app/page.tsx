...
function WaitlistModal({ onClose }: { onClose: () => void }) {
  ...
  return (
    <div onClick={onClose} style={{ position: 'fixed', inset: 0, background: 'rgba(0,0,0,0.85)', zIndex: 1000, display: 'flex', alignItems: 'center', justifyContent: 'center', backdropFilter: 'blur(8px)', padding: '20px' }}>
      <div onClick={e => e.stopPropagation()} style={{ background: '#0f0f0f', border: '0.5px solid rgba(255,255,255,0.1)', borderRadius: '20px', padding: '48px', width: '100%', maxWidth: '440px', position: 'relative' as const }}>
      ...
      <div style={{ position: 'relative', zIndex: 1 }}>
        ...
        <section style={{ maxWidth: '1000px', margin: '0 auto', padding: '120px 24px 100px', position: 'relative' as const, overflow: 'hidden' }}>
          ...
          <div style={{ display: 'flex', alignItems: 'flex-start', gap: '48px', flexWrap: 'wrap' as const }}>
            ...
            <div style={{ display: 'flex', flexDirection: 'column' as const, gap: '12px', flex: '0 0 auto' }}>
              {currentUser ? (
