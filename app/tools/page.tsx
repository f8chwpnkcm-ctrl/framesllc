      ...
      <div style={{ padding: '64px 40px' }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '12px' }}>
          ...
          <Link href="/tools/shot-list" style={{ textDecoration: 'none' }}>
            <div style={{ background: 'rgba(255,255,255,0.03)', border: '0.5px solid rgba(255,255,255,0.08)', borderRadius: '14px', padding: '28px', cursor: 'pointer', transition: 'border-color 0.2s', height: '100%' }}>
          ...
          <div style={{ background: 'rgba(255,255,255,0.03)', border: '0.5px solid rgba(255,255,255,0.08)', borderRadius: '14px', padding: '28px', cursor: 'pointer' }}>
            ...
            <div style={{ color: 'rgba(255,255,255,0.4)', fontSize: '13px', lineHeight: '1.6', marginBottom: '20px' }}>Create clean, professional invoices for clients in seconds.</div>
            <span style={{ fontSize: '11px', fontWeight: '600', color: 'rgba(255,255,255,0.3)', background: 'rgba(255,255,255,0.05)', padding: '4px 10px', borderRadius: '4px' }}>Coming soon</span>
          </div>
