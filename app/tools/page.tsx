        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(260px, 1fr))', gap: '16px' }}>
          ...
          <Link href="/tools/shot-list" style={{ textDecoration: 'none' }}>
            <div style={{ background: 'rgba(255,255,255,0.03)', border: '0.5px solid rgba(255,255,255,0.08)', borderRadius: '16px', padding: '32px', height: '100%' }}>
              ...
              <div style={{ color: 'rgba(255,255,255,0.4)', fontSize: '14px', lineHeight: '1.7', marginBottom: '24px' }}>Answer a few questions and get a professional AI-generated shot list in seconds.</div>
          ...
          <Link href="/tools/invoice" style={{ textDecoration: 'none' }}>
            <div style={{ background: 'rgba(255,255,255,0.03)', border: '0.5px solid rgba(255,255,255,0.08)', borderRadius: '16px', padding: '32px', height: '100%' }}>
              ...
              <div style={{ color: 'rgba(255,255,255,0.4)', fontSize: '14px', lineHeight: '1.7', marginBottom: '24px' }}>Describe the job and get a clean professional invoice with AI line items. Print or save as PDF.</div>
              <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
                <span style={{ fontSize: '11px', fontWeight: '600', color: '#FFE500', background: 'rgba(255,229,0,0.1)', padding: '4px 10px', borderRadius: '4px' }}>Free</span>
                <span style={{ color: 'rgba(255,255,255,0.2)', fontSize: '18px' }}>→</span>
              </div>
          ...
          <Link href="/tools/mood-board" style={{ textDecoration: 'none' }}>
            <div style={{ background: 'rgba(255,255,255,0.03)', border: '0.5px solid rgba(255,255,255,0.08)', borderRadius: '16px', padding: '32px', height: '100%' }}>
              ...
              <div style={{ color: 'rgba(255,255,255,0.4)', fontSize: '14px', lineHeight: '1.7', marginBottom: '24px' }}>Describe a vibe and get a full creative brief — color palette, lighting, camera settings, LUT style.</div>
              <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
                <span style={{ fontSize: '11px', fontWeight: '600', color: '#FFE500', background: 'rgba(255,229,0,0.1)', padding: '4px 10px', borderRadius: '4px' }}>Free</span>
                <span style={{ color: 'rgba(255,255,255,0.2)', fontSize: '18px' }}>→</span>
              </div>
