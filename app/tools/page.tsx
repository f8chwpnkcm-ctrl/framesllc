      ...
      <div style={{ padding: '64px 40px' }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '12px' }}>
          <Link href="/tools/shot-list" style={{ textDecoration: 'none' }}>
            <div style={{ background: 'rgba(255,255,255,0.03)', border: '0.5px solid rgba(255,255,255,0.08)', borderRadius: '14px', padding: '28px', cursor: 'pointer', height: '100%' }}>
          ...
          <div style={{ background: 'rgba(255,255,255,0.02)', border: '0.5px solid rgba(255,255,255,0.05)', borderRadius: '14px', padding: '28px', opacity: 0.5 }}>
            ...
            <div style={{ color: 'rgba(255,255,255,0.4)', fontSize: '13px', lineHeight: '1.6', marginBottom: '20px' }}>More tools are in the works.</div>
